    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-radial from-[#1e1b4b] via-[#09090b] to-black px-4 text-white">
      ...
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="mt-4 text-2xl font-bold tracking-tight text-zinc-100">Create account</h2>
          <p className="mt-1 text-sm text-zinc-400">Join the Omni-Platform today</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div>
            ...
            <input
              type="text"
              required
              className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white placeholder-zinc-500 outline-hidden transition focus:border-indigo-500 focus:bg-white/10"
              placeholder="johndoe"
              value={username}
