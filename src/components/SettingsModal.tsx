            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-line bg-surface p-5 space-y-3">
                ...
                <div className="flex items-center justify-between p-3.5 rounded-xl border border-line bg-surface-2">
                  ...
                  {profile?.email ? (
                    <span className="text-[10px] font-extrabold px-2.5 py-1 rounded-lg bg-accent/15 text-accent border border-accent/30">
                      연동 완료
                    </span>
                  ) : (
                    <a
                      href="/api/auth/google"
                      className="flex items-center gap-1.5 rounded-lg border border-accent/40 bg-accent-soft px-3 py-1.5 text-xs font-bold text-accent hover:bg-accent/20 transition"
                    >
                      <span>Google 연동하기</span>
                    </a>
                  )}
                </div>
              </div>
